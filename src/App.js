        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <Project
                ...
                motivation="I want a tool like this to exist, and I'm currently working on making it a reality."
          ...
          <Route
            ...
            element={
              <Project
                title="StockDigestAI"
                img={process.env.PUBLIC_URL + "/images/StockDigestAI.png"}
                link="https://github.com/TN0123/TiDB-Stock-Analyst"
          ...
          <Route
            ...
            element={
              <Project
                title="Carbon Emissions Visualizer"
                img={
          ...
          <Route
            ...
            element={
              <Project
                title="Cerebro"
                img={process.env.PUBLIC_URL + "/images/Cerebro Logo.jpg"}
          ...
          <Route
            ...
            element={
              <Project
                title="FaceLogger"
                img={process.env.PUBLIC_URL + "/images/FaceLoggerDemo (1).gif"}
          ...
          <Route
            ...
            element={
              <Project
                title="LLTrainer"
                img={process.env.PUBLIC_URL + "/images/LLTrainerDemo (1).gif"}
